...
namespace SEDC.CSharpAdv.VideoRental.Services.Menu
{
    public static class Screen
    {
        ...
        public static void StartMenu()
        {
            ...
            Console.WriteLine("Use the numbers in front of the selection to navigate through the applicaton.");
        ...
        {
            Console.WriteLine("Use the numbers in front of the selection to navigate though the applicaton.");
            Console.WriteLine("1. View all videos");
