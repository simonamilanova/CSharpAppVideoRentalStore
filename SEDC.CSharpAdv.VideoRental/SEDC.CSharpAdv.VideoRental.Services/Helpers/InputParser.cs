...
namespace SEDC.CSharpAdv.VideoRental.Services.Helpers
{
    ...
    {
        private static List<string> _validConfirmInputs = new List<string> { "Y", "y", "yes", "Yes", "1", "True" };
        private static List<string> _validDeclineInputs = new List<string> { "N", "n", "no", "No", "0", "False" };
